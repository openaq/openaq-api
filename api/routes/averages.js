...
//TODO: UPDATE API DESCRIPTION BELOW
/**
...
module.exports = [
    {
        ...
        path: '/v1/averages',
        config: {
            description: 'Retrieve measurement averages for specified spatial and temporal resolutions.',
            validate: {
                query: {
                    ...
                    temporal: [Joi.string()], //location, city, country, global
                    spatial: [Joi.string()], //hourly, daily (current restriction), monthly, yearly, all-time?
